...
import { convertNumbers } from "../../../functions/covertNumbers";
...
function List({ coin, delay, isWatchlistPage }) {
  ...
  return (
    <Link to={`/coin/${coin.id}`}>
          ...
          >
            <Tooltip placement="bottom-start" title="COIN LOGO" arrow>
              <td className="td-img">
                <img src={coin.image} className="coin-image"  alt="coin_image"/>
              </td>
            </Tooltip>
            <Tooltip placement="bottom-start" title="COIN INFO" arrow>
